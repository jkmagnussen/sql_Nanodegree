...
2(b). SELECT region, (SUM(forest_area_sq_km)/SUM(land_area_sq_km)*100) AS perecent_forest FROM forestation1 WHERE year = 2016 GROUP BY region ORDER BY perecent_forest DESC;


output: Latin America & Caribbean	46.1620721996047
